...
<div class="col-md-12  col-sm-12 well well-md">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2  col-sm-2">
                <input type="number" name="nbjustificatif" value="{{$unFrais->nbjustificatifs}}"  class="form-control" placeholder="Nombre de justificatifs" required min="0">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                <a href="{{url('/getListeFraisHF')}}/{{$unFrais->id_frais}}"><button type="button" class="btn btn-default btn-primary"><span class="glyphicon glyphicon-list"></span> Frais hors forfait</button></a>
            </div>
        </div>
        @endif
        <div class="col-md-6 col-md-offset-3  col-sm-6 col-sm-offset-3">
